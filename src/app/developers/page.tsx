    ...
    <div style={{ background: '#080808', minHeight: '100vh', color: '#e2e8f0' }}>
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <header style={{ marginTop: '40px', marginBottom: '48px' }}>
          ...
          <p style={{ fontSize: '18px', color: '#94a3b8', lineHeight: 1.65, maxWidth: '680px' }}>
        ...
        <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px', marginBottom: '48px' }}>
          {resources.map((resource) => (
            ...
            >
              <h2 style={{ fontSize: '18px', fontWeight: 600, color: '#f1f5f9', marginBottom: '10px' }}>
                {resource.title}
              </h2>
              <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: 1.7, marginBottom: '18px' }}>
        ...
        >
          <h2 style={{ fontSize: '20px', fontWeight: 600, color: '#f1f5f9', marginBottom: '10px' }}>
            Need integration details now?
          </h2>
          <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: 1.75, marginBottom: '18px' }}>
