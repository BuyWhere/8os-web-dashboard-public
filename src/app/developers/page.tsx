      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px', marginBottom: '48px' }}>
          {resources.map((resource) => (
            ...
            >
              <h2 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: '10px' }}>
                {resource.title}
              </h2>
        ...
        >
          <h2 style={{ fontSize: '20px', fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: '10px' }}>
