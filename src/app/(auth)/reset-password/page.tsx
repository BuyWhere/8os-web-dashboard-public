...
const styles: Record<string, React.CSSProperties> = {
  ...
  warningBox: { background: '#FFFBEB', border: '1px solid #FCD34D', color: '#92400E', borderRadius: '8px', padding: '0.75rem 1rem', fontSize: '0.875rem', marginBottom: '0.5rem' },
  successBox: { background: '#F0FDF4', border: '1px solid #86EFAC', color: '#15803D', borderRadius: '8px', padding: '0.75rem 1rem', fontSize: '0.875rem' },
