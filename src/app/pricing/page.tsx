...
const tierDescStyle: React.CSSProperties = { margin: 0, minHeight: '4.5rem', fontSize: '0.9rem', lineHeight: 1.65, color: 'var(--color-text-secondary)' };
...
const featureItemStyle = (included: boolean): React.CSSProperties => ({ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', fontSize: '0.85rem', lineHeight: 1.5, color: 'var(--color-text-secondary)', textDecoration: included ? 'none' : 'line-through' });
